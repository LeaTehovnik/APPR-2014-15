...
cat("Rišem zemljevid...\n")
cairo_pdf("porocilo/anidve.pdf", width = 8, height = 6, family = "Arial", onefile = TRUE) 
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = "blue")
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
mesta <- data.frame("long" = c(-0.13), "lat" = c(51.51))
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = "green")
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("green","blue"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
mesta <- data.frame("long" = c(-0.13), "lat" = c(51.51))
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = "red")
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("blue", "green"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
mesta <- data.frame("long" = c(4.89, 174.76, -73.55, -74.01, 139.69),
                    "lat" = c(52.37, -36.85, 45.51, 40.71, 35.69))
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("blue", "blue","blue","green","green"))       
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("blue", "red"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("red","blue"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("blue","yellow"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("blue"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("green","yellow"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("green"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
...
mesta <- data.frame("long" = c(13.41), "lat" = c(52.52))
points(coordinates(mesta), type = "p", pch = 19, cex = 1, col = c("red"))
legend("left", legend = c("do 5x", "do 10x","do 15x", "do 20x"),
       col = c("blue","green","red","yellow"),
       pt.cex = 1, title = "kolikorat je že bil podrt rekord", pch = 19, cex = 0.7)
